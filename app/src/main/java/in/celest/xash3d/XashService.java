...
public class XashService extends Service 
{
	...
	public int onStartCommand(Intent intent, int flags, int startId) 
	{
		...
		if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O)
		{
			...
			NotificationChannel mChannel = new NotificationChannel("csmoe001", "CSMoE Notification", NotificationManager.IMPORTANCE_HIGH);
			notificationManager.createNotificationChannel(mChannel);

			Notification.Builder nb =  new Notification.Builder(getApplicationContext(), "csmoe001");
			nb.setSmallIcon(R.drawable.ic_statusbar);
			nb.setContentTitle("Xash3D Engine");
			nb.setContentText("CSMoE is running");

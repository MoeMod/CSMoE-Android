...
APP_CFLAGS += -Wall -Wextra -Wpedantic -Wno-unused-parameter -Wno-unused-variable -Wno-unused-but-set-variable -Wl,--no-undefined
...
NANOGL_PATH := $(APPLICATIONMK_PATH)/src/NanoGL

XASH3D_PATH := $(APPLICATIONMK_PATH)/src/Xash3D

HLSDK_PATH  := $(APPLICATIONMK_PATH)/src/Xash3D
...
APP_MODULES := client server xash menu NanoGL gpgs_support
